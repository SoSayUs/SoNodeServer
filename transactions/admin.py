...
class TxAdmin(AutoForeignKeyAdmin):
    list_display = ["id",'tokens','ReceiverWallet_obj','SenderWallet_obj',full_utc('enact_dt'),'enacted','validated',full_utc('created'),full_utc('updated_on_node')]
    list_display_links = []
    list_editable = []
    list_filter = []
